...
const adminReportsRouter = require("./AdminRoutes/AdminReportsRouter");
const adminAdsRouter = require("./AdminRoutes/AdminAdsRouter");
...
adminRouter.use("/reports", verifyToken, adminReportsRouter);
adminRouter.use("/ads", verifyToken, adminAdsRouter);
